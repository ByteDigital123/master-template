...
use App\Http\Resources\Website\ContentType\StoreContentTypeRequest;
use App\Http\Resources\Website\ContentType\UpdateContentTypeRequest;
...
class ContentTypeController extends Controller
{
    ...
    {
        return ContentTypeResource::collection($this->service->getAll());
    }
